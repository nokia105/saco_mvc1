    <!-- Main content -->
     ...
     @extends('layouts.master')
      ...
      <form method="post" action="{{route('drafted.update',$loan->id)}}" enctype="multipart/form-data">
     ...
     <div class="box col-md-12 box-danger">
        ...
        <div class="box-header">
         ...
         <div class="box-body">
          ...
          <div class="col-sm-12{{$errors->has('salary_slip') ? ' has-error' : '' }}">

                <label for="">upload Salary Slip</label>
               <input name="salary_slip" type="file"  value="{{$loan->salary_slip}}" multiple / >
                <small class="text-danger">{{ $errors->first('salary_slip') }}</small> 
              </div>
            </div>
            <!-- /.col -->
         ...
         <div class="box-body">
          <div class="row">
            <div class="col-md-2">
              ...
              <div class="form-group">
                  <label for=""></label>
                  <input type="submit"  value="Update" class="form-control btn btn-info pull-left" >
              </div>
            </div>
