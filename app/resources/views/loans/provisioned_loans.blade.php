@extends('layouts.master')
   @section('content')
            ...
            @section('title', '|Provisioned Loans')
       <div class="row">
       <div class="col-xs-12">
         <div class="error" style="text-align:center">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Provisioned</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="btn-group">
        ...
        <li><a href="{{route('provisioned.edit',$loan->id)}}" class="fa fa-edit" style="color:blue; font-size:15px;">Edit</a></li>
