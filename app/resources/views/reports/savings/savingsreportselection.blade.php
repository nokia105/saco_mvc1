 @extends('layouts.master')
      ...
      @section('title', '| Savings Reports')
       ...
       <form action="{{route('find_savingsreport')}}" method="post">
  ...
  <label class="custom-control-label" for="customRadio2">Annually</label>
          ...
          <div class="row">
            <div class="col-md-3" style="padding-top:20px">
              ...
              <select class="form-group form-control" name="savings">
                <option>Select report type</option> 
                <option value="total_saving">Total savings</option> 
                <option value="refunded_saving">Funded savings</option>  
              </select>
            </div>
