       ...
       <div class="col-xs-12">
          ...
          <div class="box">
           <div class="box-header">
                 ...
                 <h3 class="box-title">Month: {{$monthName}} <strong></strong> <br> <br>Year : {{$year}} <strong></strong></h3>         
            </div>
            <!-- /.box-header -->
...
buttons: [
            ...
            title:' <div style="text-align:center;  font-size:16px; padding-top:10%">TASAF SACCOS <br/><br/> Finished Loans  {{$monthName}}, {{$year}} <br/><br/></div>',
