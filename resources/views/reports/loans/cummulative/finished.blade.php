...
buttons: [
            ...
            title:'<div style="text-align:center;  font-size:16px; padding-top:10%">TASAF SACCOS <br/><br/> Finished Loans Start: {{\Carbon\carbon::parse($endDate)->format('d/m/Y')}}  Ends: {{\Carbon\carbon::parse($endDate)->format('d/m/Y')}}  <br/><br/></div>',
